...
class SIM_API cNEDNetworkBuilder
{
  ...
  protected:
    ...
    void addSubmodulesAndConnections(cModule *modp, bool isPlaceholder);
    void addSubmodulesAndConnections(cModule *modp);
    bool superTypeAllowsUnconnected(cNEDDeclaration *decl) const;
    void buildRecursively(cModule *modp, cNEDDeclaration *decl, bool isPlaceholder);
  ...
  public:
     ...
     */
    void buildInside(cModule *module, cNEDDeclaration *decl, bool isPlaceholder);
};
