...
IFlowRoutingTable::IFlowRoutingTable()
{
    ift = NULL;
    nb = NULL;
}
...
void IFlowRoutingTable::initialize(int stage)
{
...
void IFlowRoutingTable::configureRouterId()
{
...
void IFlowRoutingTable::updateDisplayString()
{
    if (!ev.isGUI())
        return;
...
void IFlowRoutingTable::handleMessage(cMessage *msg)
{
    throw cRuntimeError("This module doesn't process messages");
}

void IFlowRoutingTable::receiveChangeNotification(int category, const cObject *details)
{
...
cModule *IFlowRoutingTable::getHostModule()
{
    return findContainingNode(this);
}

void IFlowRoutingTable::deleteInterfaceRoutes(InterfaceEntry *entry)
{
    bool changed = false;
...
void IFlowRoutingTable::invalidateCache()
{
...
void IFlowRoutingTable::printRoutingTable() const
{
    EV << "-- Routing table --\n";
...
void IFlowRoutingTable::printMulticastRoutingTable() const
{
...
std::vector<IPv4Address> IFlowRoutingTable::gatherAddresses() const
{
...
void IFlowRoutingTable::configureInterfaceForIPv4(InterfaceEntry *ie)
{
...
InterfaceEntry *IFlowRoutingTable::getInterfaceByAddress(const IPv4Address& addr) const
{
...
void IFlowRoutingTable::configureLoopbackForIPv4()
{
...
bool IFlowRoutingTable::isLocalAddress(const IPv4Address& dest) const
{
...
bool IFlowRoutingTable::isLocalBroadcastAddress(const IPv4Address& dest) const
{
...
InterfaceEntry *IFlowRoutingTable::findInterfaceByLocalBroadcastAddress(const IPv4Address& dest) const
{
    for (int i=0; i<ift->getNumInterfaces(); i++)
    {
        InterfaceEntry *ie = ift->getInterface(i);
...
bool IFlowRoutingTable::isLocalMulticastAddress(const IPv4Address& dest) const
{
...
InterfaceEntry *IFlowRoutingTable::getInterfaceForDestAddr(const IPv4Address& dest) const
{
...
IPv4Address IFlowRoutingTable::getGatewayForDestAddr(const IPv4Address& dest) const
{
...
const IPv4MulticastRoute *IFlowRoutingTable::findBestMatchingMulticastRoute(const IPv4Address &origin, const IPv4Address &group) const
{
...
IPv4Route *IFlowRoutingTable::getRoute(int k) const
{
...
IPv4Route *IFlowRoutingTable::getDefaultRoute() const
{
...
bool IFlowRoutingTable::routeLessThan(const IPv4Route *a, const IPv4Route *b)
{
...
void IFlowRoutingTable::setRouterId(IPv4Address a)
{
    routerId = a;
}

void IFlowRoutingTable::internalAddRoute(IPv4Route *entry)
{
...
void IFlowRoutingTable::addRoute(IPv4Route *entry)
{
...
IPv4Route *IFlowRoutingTable::internalRemoveRoute(IPv4Route *entry)
{
...
IPv4Route *IFlowRoutingTable::removeRoute(IPv4Route *entry)
{
...
bool IFlowRoutingTable::deleteRoute(IPv4Route *entry)
{
...
bool IFlowRoutingTable::multicastRouteLessThan(const IPv4MulticastRoute *a, const IPv4MulticastRoute *b)
{
...
void IFlowRoutingTable::internalAddMulticastRoute(IPv4MulticastRoute *entry)
{
...
void IFlowRoutingTable::addMulticastRoute(IPv4MulticastRoute *entry)
{
...
IPv4MulticastRoute *IFlowRoutingTable::internalRemoveMulticastRoute(IPv4MulticastRoute *entry)
{
...
IPv4MulticastRoute *IFlowRoutingTable::removeMulticastRoute(IPv4MulticastRoute *entry)
{
...
bool IFlowRoutingTable::deleteMulticastRoute(IPv4MulticastRoute *entry)
{
...
void IFlowRoutingTable::routeChanged(IPv4Route *entry, int fieldCode)
{
...
void IFlowRoutingTable::multicastRouteChanged(IPv4MulticastRoute *entry, int fieldCode)
{
...
void IFlowRoutingTable::updateNetmaskRoutes()
{
...
bool IFlowRoutingTable::handleOperationStage(LifecycleOperation *operation, int stage, IDoneCallback *doneCallback)
{
    Enter_Method_Silent();
...
IPv4Route *IFlowRoutingTable::createNewRoute()
{
