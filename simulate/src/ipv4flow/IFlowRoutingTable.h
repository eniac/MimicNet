 ...
 */
class INET_API IFlowRoutingTable: public cSimpleModule, public IRoutingTable, protected INotifiable, public ILifecycle
{
  protected:
  ...
  protected:
    ...
    virtual void invalidateRoutingCache() = 0;
  ...
  public:
    ...
    virtual IPv4Route* findBestMatchingRoute(const IPv4Address& src,
                                             const IPv4Address& dest) const = 0;
    virtual IPv4Route* findBestMatchingRoute(const IPv4Address& src,
                                             const IPv4Address& dest,
                                             const uint64_t msgId) const = 0;
    virtual IPv4Route* findBestMatchingRoute(const IPv4Address& src,
                                             unsigned short srcPort,
                                             const IPv4Address& dest,
                                             unsigned short destPort) const = 0;
