...
class SIM_API cSimpleModule : public cModule //implies noncopyable
{
  ...
  private:
    ...
    long nextLocalUniqueNumber; //used to generate numbers which are unique on a given module
  ...
  public:
    ...
    //@}
     ...
     /**
      *  Returns a unique number (unique on this simple module) each time called.
      */
    unsigned long getLocalUniqueNumber();
