...
##  Feature vector for 2-rack Homa (20 features)
...
##      14 - Priority
##      15 - Packet length
##      16 - Time since last packet
##      17 - EWMA
##      18 - Last drop prediction
##      19 - Last latency prediction
...
def format_data(X, y_d, y_l, num_servers = 4, degree = 2, priorities = 8,
    ...
    # Priority values actually have meaning
    #Prio = convertToOneHot(X.T[5].astype(int), priorities)
...
if __name__ == '__main__':
    ...
    parser_model.add_argument("--homa_priorities", dest="homa_priorities",
                              help="How many priority levels in Homa")
    ...
    parser.set_defaults(homa_priorities=8)
    ...
    homa_priorities = args.homa_priorities
    ...
    if args.load_model:
        ...
        assert checkpoint["variant"] == "Homa"
