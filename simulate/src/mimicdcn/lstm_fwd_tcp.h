...
class MimicNetLstmTcp {
public:
    MimicNetLstmTcp(const int input_size = 18, const int batch_size = 1,
    ...
    static unique_ptr<MimicNetLstmTcp> loadFromHdf5(const char* path) {
        ...
        auto model = make_unique<MimicNetLstmTcp>(
