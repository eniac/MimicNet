...
WorkloadSynthesizer::initialize()
{
    ...
    if (strcmp(workLoadType, "DCTCP") == 0) {
        ...
        distFileName = std::string("../homatransport/sizeDistributions/"
        ...
        distFileName = std::string("../homatransport/sizeDistributionss/"
        ...
        distFileName = std::string(
                "../homatransport/sizeDistributions/HostidSizeInterarrival.txt");
    } else {
...
WorkloadSynthesizer::idealMsgEndToEndDelay(AppMessage* rcvdMsg)
{
    ...
    IPvXAddress srcAddr = rcvdMsg->getSrcAddr();
    //ASSERT(srcAddr.getType() == IPvXAddress::AddressType::IPv4);
    IPvXAddress destAddr = rcvdMsg->getDestAddr();
    //ASSERT(destAddr.getType() == IPvXAddress::AddressType::IPv4);
    ...
    if (destAddr.get4().getDByte(2) == srcAddr.get4().getDByte(2)) {
    ...
    } else if (destAddr.get4().getDByte(1) == srcAddr.get4().getDByte(1)) {
