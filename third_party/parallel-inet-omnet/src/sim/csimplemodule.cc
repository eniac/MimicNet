...
cSimpleModule::cSimpleModule(unsigned stksize)
{
    ...
    //used by getLocalUniqueNumber(), to generate Unique numbers for a module.
    nextLocalUniqueNumber = 0;
...
unsigned long cSimpleModule::getLocalUniqueNumber()
{
    return nextLocalUniqueNumber++;
}
